...
const ConfigSchema = z.object({
  ...
  mcp: z.object({ host: z.string().default("127.0.0.1"), port: z.number().int().min(1).max(65535).default(8767) }),
  admin: z.object({ host: z.string().default("127.0.0.1"), port: z.number().int().min(1).max(65535).default(8768), allowLanHttp: z.boolean().default(false) }),
